...
%save variables
save('AcartiaMu_complex_HMM_Pred_future.txt','AcartiaMu','-ascii')
save('AcartiaSigma_complex_HMM_Pred_future.txt','AcartiaSig','-ascii')

save('DaphniaMu_complex_HMM_Pred_future.txt','DaphniaMu','-ascii')
save('DaphniaSigma_complex_HMM_Pred_future.txt','DaphniaSig','-ascii')

save('EubosMu_complex_HMM_Pred_future.txt','EubosMu','-ascii')
save('EubosSigma_complex_Pred_future.txt','EubosSig','-ascii')

save('EurytMu_complex_HMM_Pred_future.txt','EurytMu','-ascii')
save('EurytSigma_complex_HMM_Pred_future.txt','EurytSig','-ascii')

save('EvadneMu_complex_HMM_Pred_future.txt','EvadneMu','-ascii')
save('EvadneSigma_complex_HMM_Pred_future.txt','EvadneSig','-ascii')

save('PleopsisMu_complex_HMM_Pred_future.txt','PleopsisMu','-ascii')
save('PleopsisSigma_complex_HMM_Pred_future.txt','PleopsisSig','-ascii')

save('SynchMu_complex_HMM_Pred_future.txt','SynchMu','-ascii')
save('SynchSigma_complex_HMM_Pred_future.txt','SynchSig','-ascii')