...
% time variable
intra(1, [2:5 7:13 15:21]) = true; % Quarter as a general explanatory variable / gategorical
...
onodes = [1:5, 7:13, 15:21]; % Quarter as a continuous node as well..
...
for i = 1:t
    ...
    save('Quarter_Plankton_GenHVMu_Dynamic_VERSIOB.txt','HVGenMu','-ascii')
    save('Quarter_Plankton_ZooHVMu_Dynamic_VERSIOB.txt','HVZooMu','-ascii')
    
    save('Quarter_Plankton_GenHVSig_Dynamic_VERSIOB.txt','HVGenSigma','-ascii')
    save('Quarter_Plankton_ZooHVSig_Dynamic_VERSIOB.txt','HVZooSigma','-ascii')