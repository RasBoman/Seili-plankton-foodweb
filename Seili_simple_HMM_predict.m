...
t=datlen % The zooplankton is already NA in the final 12 years of the table
...
%save variables
save('AcartiaMu_simple_HMM_Pred.txt','AcartiaMu','-ascii')
save('AcartiaSigma_simple_HMM_Pred.txt','AcartiaSig','-ascii')

save('DaphniaMu_simple_HMM_Pred.txt','DaphniaMu','-ascii')
save('DaphniaSigma_simple_HMM_Pred.txt','DaphniaSig','-ascii')

save('EubosMu_simple_HMM_Pred.txt','EubosMu','-ascii')
save('EubosSigma_simple_Pred.txt','EubosSig','-ascii')

save('EurytMu_simple_HMM_Pred.txt','EurytMu','-ascii')
save('EurytSigma_simple_HMM_Pred.txt','EurytSig','-ascii')

save('EvadneMu_simple_HMM_Pred.txt','EvadneMu','-ascii')
save('EvadneSigma_simple_HMM_Pred.txt','EvadneSig','-ascii')

save('PleopsisMu_simple_HMM_Pred.txt','PleopsisMu','-ascii')
save('PleopsisSigma_simple_HMM_Pred.txt','PleopsisSig','-ascii')

save('SynchMu_simple_HMM_Pred.txt','SynchMu','-ascii')
save('SynchSigma_simple_HMM_Pred.txt','SynchSig','-ascii')